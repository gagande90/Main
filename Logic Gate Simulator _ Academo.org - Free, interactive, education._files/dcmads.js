...
try {
	var __IntegralASConfig = {
		...
		sp_cdnScripts: {xsca: "static.adsafeprotected.com/xsca.17.4.85.js", sca: "static.adsafeprotected.com/sca.17.4.114.js", main: "static.adsafeprotected.com/main.19.8.86.js"},
		protocol: 'https',
		jsref: "https:\/\/cd16b5b0f1d5a53c27a27627c88ff6b8.safeframe.googlesyndication.com\/safeframe\/1-0-37\/html\/container.html",
		asid: "23c74e1c-aeb1-11ea-9994-0ac5e938fe56",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=424948",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/www.googletagservices.com\/424948\/44239881\/dcm\/dcmads.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/www.googletagservices.com\/424948\/44239881\/dcm\/dcmads.js",
		accountForSadImps: '',
		sendCookie: 'true',
		cookieBaseURL: 'sc.iasds01.com\/dtc?advEntityId=424948&pubEnt=44239881',
		fwMonitoring: 'false',
		doNothing: false,
		mn: "app02au",
		mobOrTab: false,
		app: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/blocking\/app\/initial\/424948\/44239881?redirectUrl=https%3A%2F%2Fwww.googletagservices.com%2Fdcm%2Fdcmads.js",
		anId: '',
		advEntityId: '424948',
		pubEntityId: '44239881',
		videoId: '',
		videoChannel: '',
		rts: {},
		customViewability: [],
...
__IntegralASConfig.initialize=function(m,w,N){function Ta(){var g,a,b;m.perf.markStart(ma);l.startSystem();y=l.getAggregator();y.provide({omidAdSessionContext:{}});y.provide({omidAdSessionVerificationParameters:{}});g=Ua();a=na();b=(new Va).createInstance(g,a);y.provide({mErrors:g,mJsonp:a,mComm:b});g=__IASOmidVerificationClient;y.provide({omidVerificationClient:g});y.once("callContinueMain",function(){var a,b;m.perf.markStart(oa);b=Y.instantiateModules();a=Y.preImpression(b.mDataTransfer,b.mViewability,
...
a)});y.once("requestBootstrapper",function(a){var b=m.forcedBootstrapperHost||"http://jsconfig.adsafeprotected.com";"string"===typeof a&&(a=JSON.parse(a));var e=a&&a.config,k=a&&a.sca,s=a&&a.xsca;e&&y.trigger("jsonp",b+"/jsconfig"+e+(m.adSessionId?"&adSessionId="+m.adSessionId:""),function(a){Object.assign(m,"string"===typeof a?JSON.parse(a):a);m.isResolved=!0;m.sp_cdnScripts={sca:k,xsca:s};y.trigger("callContinueMain")},!1,"cbName")});g=[{environment:new da(g),adSessionReadyStrategy:new Wa(g)},{environment:new Xa,
adSessionReadyStrategy:new Ya}];(new Za(g)).resolve().adSessionReadyStrategy.start();m.perf.markEnd(ma)}var y,Y=function(){function g(a){var b=new $a(a,t),c=new ab,d=new bb(a,t),p=cb(a,t),q=(new db(m,t,a)).resolve(),g=[b],C=[];p.applies()&&g.push(p);d.applies()&&g.push(d);c.applies(a,t)&&g.push(c);f(q).each(function(a,b){g.push(new eb(b,t));C.push(b.id)});0<C.length&&(y.trigger("addOutputItem",{output:C.join(".")},"scm",{type:h.IMPRESSION_EVENT}),y.trigger("addOutputItem",{output:C},"metricIdList",
{type:h.DT_CODES.UNLOAD,asION:!0}));return g}function a(a,b,c,d){var p=g(a);y.provide("viewabilityDefinitions",p);return f(p).map(function(p,g){var f,v,l;f=new pa(g,b);var K=(new fb(c,a,g.rts)).getCallbacks(),x=new qa(d.createPingJobs(g.type,g.timeInViewThresholds,K,g.metricId));g.sendOtherwiseInViewSignal&&(l=new pa(g,b,g.sendOtherwiseInViewSignal),v=new qa(d.createPingJobs(g.type,g.timeInViewThresholds,K,g.metricId,g.sendOtherwiseInViewSignal)));g.rtsCallbacks=K;g.thresholdType===h.GROUPM_MOBILE_PASS_THRU_TIME_IN_VIEW_THRESHOLD_TYPE?
f=new gb(f,g,x,t.isVideo()):(f=new ra(f,new Z(g.minUnit),x),g.sendOtherwiseInViewSignal&&(v=new ra(l,new Z(g.minUnit),v,g.sendOtherwiseInViewSignal),v.start()));f.start();return f})}function b(a,b){var c=(new ea).accepts(),c=!t.isAvid()&&!c&&!t.isInMobiMraidVideo();return t.isVideo()&&c?hb(m.videoId,a,b):{}}function c(a,b,c,d,p,q,g,C,v,G){try{m.perf.markStart(sa),m.tpiLookupURL&&ib(g,C).init(m.tpiLookupURL),t.isDomless()||G.isStarted()&&G.sendOriginList(),l.runAll(),r.execAtEndOfThread(function(){var q;
try{m.perf.markStart(ta);q={output:(new Date).getTime()-p};a.addItem(q,"sinceFw",{type:h.DT_CODES.ADTALK});f.isDef(b.loopStarted())&&a.addItem({output:b.loopStarted()},"readyFired",{type:h.DT_CODES.ADTALK});m.perf.markEnd(ta);var g,z;m.isSplitMode&&(z=m.protocol+"://"+m.sp_cdnScripts.main,m.perf.markResource(jb,z));m.impUrl&&m.perf.markResource(kb,m.impUrl);g=m.perf.getData();y.trigger("addThrottledProp",h.DT_SLOT.IM,"prf",f(g).toION());c.isApplicable(t)&&c.sendAdTalkCall()}catch(C){d.add(h.ERROR_CODES.ADTALK_DELAY)}}),
m.perf.markEnd(sa)}catch(K){d.add(h.ERROR_CODES.EVENT_LOOP_ONE)}}function d(a,b,d,n,p,q,g,f,v){var h;"true"!==m.minimizeCalls&&(h=(new Date).getTime(),r.execAtEndOfThread(function(){c(a,b,d,n,h,p,q,g,f,v)}))}return{instantiateModules:function(){var c,d,s,n,p,q,g,f,v={};m.perf.markStart(ua);y=l.getAggregator();v.mFeatures=y.provide("features",lb());y.provide("mobileApp",function(){return c=c||new mb(v.mFeatures)});y.provide("avidJsClient",function(){return d=d||new nb(r.getWindow())});y.provide("context",
t);v.mBrowser=y.provide("browser",(new ob).createInstance());v.mErrors=y.request("mErrors");v.mIds=y.provide("ids",pb());v.iOutput=new qb(y);y.request("mJsonp");v.mComm=y.request("mComm");v.viewabilityMeasurement=(new rb(new sb(v.mIds),v.mFeatures,v.mBrowser)).create();if((n=y.request("omidAdSessionContext"))&&n.queuedOutputItems)for(q=0;q<n.queuedOutputItems.length;q++)y.trigger("addOutputItem",{output:n.queuedOutputItems[q].value},n.queuedOutputItems[q].code,{type:"impression"});v.mFeatures.on("swapids")&&
(m.oid=m.asid,m.asid=v.mIds.unq);v.mAdTalk=(new tb).createInstance(v.mFeatures);s=ub();n=vb(y);p=y.provide("mPage",(new wb).createInstance());v.mAncestorOrigins=xb();v.mPageUrls=y.provide("pageUrls",(new yb).createInstance(v.mAncestorOrigins,r));q=y.provide("mScreenEvents",zb());y.provide("ieXDomainViewability",Ab(v.mBrowser));g=Bb(v.mBrowser);f=b(v.mFeatures,q);v.mVideo=y.provide("video",f);Cb(Db.build());g=(new Eb).createInstance(v.mErrors,g,v.mFeatures);p=(new Fb).createInstance(g,v.mErrors,p,
t);f=y.provide("jobFactory",Gb());v.mDataTransfer=Hb(g,v.mErrors,v.mFeatures,v.mIds,v.iOutput,v.mBrowser,q,s);s=Ib(v.mErrors,v.mFeatures,y,n);v.mMode=Jb(s,v.mFeatures,v.viewabilityMeasurement.isImmediate());v.mViewability=y.provide("viewability",Kb(new H,v.viewabilityMeasurement,v.mBrowser,v.mDataTransfer,v.mFeatures,y,v.iOutput,p,q,v.mVideo));a(v.mFeatures,v.mViewability,n,f);v.loopDelay=va();v.renderDetector=Lb();v.mDataTransfer.setViewabilityMod(v.mViewability);m.perf.markEnd(ua);return v},preImpression:function(a,
b,c,d,p,q,g,f,v,l,K){var x,D,r,B,t;m.perf.markStart(wa);m.b11="1"===m.adHeight&&"1"===m.adWidth?"true":"false";m.cnod=m.contextNode?"true":"false";try{c.isApplicable(l)&&(c.start(),d.addItem(c.getFrameMap(),"fm"),v.on("fm2")&&d.addItem(c.getFrameMapIncludingPeerCase(),"fm2"),v.on("idMap")&&(x=c.getIdMap())&&d.addItem(x,"idMap"))}catch(u){p.add(h.ERROR_CODES.ADTALK_GENERAL)}try{q.isApplicable(g,v,l)&&q.start(),t=f.detectTopURL(),v.on("exch")&&(D=(new Mb).createInstance(p,d),D.parse(t)),r=Nb(),r.isApplicable(v)&&
r.start(v),l.usesGroupMCustomMetric()&&Ob(),B=Pb(),B.isApplicable(v)&&(B.start(),y.trigger("sendCookie")),K.start()}catch(Qb){p.add(h.ERROR_CODES.IMPRESSION_LEADUP)}m.perf.markEnd(wa);return t},sendImpression:function(a,b,c,d,p,q,g,C,v){try{Rb(a,b,c,d,p,q,g).send(C),f.isFunction(v.triggerInitializationEvents)&&v.triggerInitializationEvents()}catch(h){__IntegralASDiagnosticCall("impsend",h,m)}},postImpression:function(a,b,c,n,p,q,g,f,v,G,K,x,D){try{m.perf.markStart(xa);var r=Sb();r.start();r.addFieldTypes([h.DT_SLOT.IM,
h.DT_SLOT.FF,h.DT_SLOT.ENVIRONMENT,h.DT_SLOT.FF_EXP]);var B=Tb(a,b,c);B.isApplicable(n)&&B.start();var t;n.bootstrapOn("getTpl")&&n.on("usetpl")&&(t=Ub(p,q,g,b,f),t.init());d(f,v,G,g,n,p,q,b,x);K&&K.start&&K.start();D.isDomless()||Vb().start(["sca","xsca","rsrch"],n);Wb();l.runTier(h.TIERS.VIEWABILITY);var u=Xb();u.isApplicable(n)&&(u.start(),T.recordBlockingTime(),m.perf.mark(Yb),T.setupOnLoadTracking(),T.setupBrowserDelayTracking());m.perf.markEnd(xa)}catch(Qb){g.add(h.ERROR_CODES.POST_IMPRESSION)}}}}(),
...
c;f=p;var C;if((m.useFIF&&t.friendlyIframe||t.isSpecifiedAd())&&3>b)a:{var v=c,G,K,x,D,Q=u.getNodeName(v);c=s(v);try{x=d.concat(c);if(v===r.getTop().document.body){C=null;break a}u.isWindow(v)?(G=n(x),G||(D="["+h.AD_IDENTIFIER+"-"+m.asid+"]",K=u.crossQuerySelector(D),a=K.parentNode,G=U(a,x,e))):("IFRAME"===Q&&(v=v.contentWindow.document,x=x.concat(s(v))),G=U(v,x,e));void 0===G&&a&&a.parentNode&&(a=G=a.parentNode,b+=1)}catch(B){l.getAggregator().trigger("renderdiag",B)}C=G}else{C=c;G=u.getNodeName(C);
K=s(C);try{Q=d.concat(K),u.isWindow(C)?v=n(Q,e):("IFRAME"===G&&(C=C.contentWindow.document),v=U(C,Q,e))}catch(L){l.getAggregator().trigger("renderdiag",L)}C=v}f=f(C)}else f=null;return f};return{find:p,getClosestContainerName:function(){return u.getNodeName(g)}}},Lb=function(){var g,a=!1,b={status:h.RENDER.STATUS.OTHER,details:h.RENDER.DETAILS.OTHER},c={status:h.RENDER.STATUS.DETECTED,details:h.RENDER.DETAILS.ENVIRONMENT},d=function(){a=!0},e=function(a){a&&(a.status=h.RENDER.STATUS.DETECTED);l.getAggregator().trigger("adRendered")},
...
r.now();a.length&&(a[a.length-1].duration+=c-b,b=c)};return{clear:function(){c();a=[]},fastForward:c,get:function(){return a},hasAlwaysBeen:function(b){return 1===a.length&&a[0].state===b},addState:function(b){var e=a[a.length-1];b=g(b);c();0!==a.length&&b===e.state||a.push({state:b,duration:0})}}},Aa=function(g,a){var b=g||1,c=0,d=0,e,k=0;return{start:function(){0===c%b&&(e=r.now())},stop:function(){var s=e||a;0===c%b&&(k+=r.now()-s,d++);c++},getTime:function(){return k},getCount:function(){return d}}},
Ba=function(){var g,a=0,b=0,c=new H(!0),d=function(){g&&(a++,c.trigger(a),b>a?r.execAtEndOfThread(d):e())},e=function(){g=!1;a=0};return{onTick:function(a,d){var e=f.collapseArgsIntoHash(a,d);f(e).each(function(a,c){a=parseInt(a);b=a>b?a:b});c.on(e)},start:function(){g||(g=!0,r.execAtEndOfThread(d))},kill:e,isActive:function(){return g}}},gc=function(g,a){var b,c=a,d=function(a){b||(a&&g(),b=r.setInterval(g,c))},e=function(a){a&&g();r.clearInterval(b);b=null};return{start:d,stop:e,updateFrequency:function(a,
...
return a},{tier:h.TIERS.ENVIRONMENT,applies:function(g,a,b){return b.isPossiblyRefreshable()}});var xb=function(){var g,a,b=function(a,b){-1!==b.indexOf("https")&&(b+="*");return b.replace(/^https?:\/\//,"")};return{isApplicable:function(a,b,e){return a.hasAncestorOrigins&&a.hasAncestorOrigins()&&b.on("ancestor")&&e.xDomainIframe},isStarted:function(){return!!a},start:function(){try{g=r.getWindow().location.ancestorOrigins,a=!0}catch(b){l.getAggregator().trigger("error",h.ERROR_CODES.ANCESTOR_ORIGINS)}},
...
0,0);f(d).each(function(a,b){g.send(b.replace("%%CBS%%",c.getCacheBustId()),function(){e(k,p,++q)},!0);e(k,++p,q)})}catch(z){b.add(h.ERROR_CODES.AT_SEND)}};return{init:function(){try{var a=(new S).fullDom;"/"!==a.slice(-1)&&(a+="/");a+="tpl?asId="+m.asid;g.jsonp(a,k)}catch(c){b.add(h.ERROR_CODES.AT_INIT)}}}},Ib=function(g,a,b,c){return{enabled:"true"===m.useBapiCallback,callback:function(a){b.trigger("sendDiag");try{"true"===m.accountForSadImps&&c.measure(a),m._onAPIResult&&m._onAPIResult(a)}catch(e){g.add(h.ERROR_CODES.BAPI_CALLBACK),
...
d.style.padding=d.style.margin=d.style.border="0px";d&&(d=d.contentWindow.document)&&(d.open().write(a(c,b)),d.close())}}},kc=function(g,a){var b=function(a,b){function c(a,b,d){"script"!==a?(b=N.createElement("DIV"),b.innerHTML=d,d=b.childNodes[0]):(d=N.createElement("SCRIPT"),d.src=b);m.contextNode.parentNode.appendChild(d)}var d,e;b=b||a;a=1<arguments.length?a:"script";d={script:['<script type="text/javascript" src="','">\x3c/script>'],iframe:['<iframe width="100%" height="100%" frameborder="0" vspace="0" hspace="0" scrolling="no" marginheight="0" marginwidth="0" src="',
'"></iframe>'],img:['<img src="','"/>']}[a];d=d[0]+b+d[1];t.isOmid()?(e=new lc,e.isApplicable(b)?e.deployBlockingScriptIntoIframe(b):c(a,b,d)):"true"===m.forceAppend?c(a,b,d):N.write(d)},c=function(a,b,c){var d=!c&&A.getXHR2();d?(d.open("POST",a),d.onreadystatechange=function(){4===d.readyState&&200===d.status&&b&&b()},d.send()):(c=u.createImage(),b&&(c.onload=b),c.src=a)},d=function(a,b,c,d){var e=N.createElement("script");c=c||m.contextNode.parentNode;e.type="text/javascript";e.src=a;b&&(e.onload=
...
c){return P.contains(c.id,a)}).length},p=function(){return n("grpm")||m.use100v};return{embedded:a,friendly:b,isFriendlyToParent:function(a){var b,c;if(g)a=!0;else{try{c=S(a.document.referrer),b=c.hostname===a.location.hostname}catch(d){}a=b}return a},friendlyIframe:a&&b,xDomainIframe:a&&!b,getTagTime:function(){return r.now()-m.birthdate},getPageTime:function(){var a=h.NA;!g&&f.isDef(w.chrome)&&f.isDef(w.chrome.csi)&&f.isFunction(w.chrome.csi)&&(a=r.round(w.chrome.csi().pageT));return a},isVideo:k,
isMobileApp:c,isSpecifiedAd:function(){var a=!1;g||(a=(a=m._cl_adpath)&&f.isStr(a));return a},isCompoundAd:function(){var a=!1,b=/\[(.*)\]/;g||(a=b.exec(m._cl_adpath),a=null!==a&&0!==a[1].length&&1<a[1].split(",").length);return a},isAvid:function(){return!g&&f.isDef(r.getWindow().avid)},isOmid:function(){var a=l.getAggregator().request("omidVerificationClient");return a&&a.isSupported()},isOmidNative:function(){return(new ea).accepts()},isOmidForWeb:function(){return(new Ca).accepts()},isDomless:function(){return g},
...
diagnostic:C,setViewabilityMod:function(a){}}},F=function(g){var a={},b=!1,c=function(){var a=1===g.nodeType?u.nodeIsHidden(g):0===g.width||0===g.height;return b?!1:a},d=function(){var b={};f(a).each(function(a,c){b[a]=r.round(c)});return b},e=function(a){return f.isNumeric(a)||f.isUndef(a)},k=function(){return r.round(a.width)*r.round(a.height)};(function(){var b;g!==w.parent&&(1!==g.nodeType?a=g:f.isDef(g.getBoundingClientRect)&&(b=u.getRect(g),f(a).mixin({x:f.useIfDef(b.x)||b.scrX,y:f.useIfDef(b.y)||
...
"OBJECT"),c="inline"!==A.getStyle(d,"display"),b&&c&&(b=u.getRect(d),e=b.width<e?b.width:e,k=b.height<k?b.height:k);while(d.parentNode!==N&&d!==a)}return{width:r.round(e),height:r.round(k)}},hasBackgroundImage:function(g){g=A.getStyle(g,"background-image");return""!==g&&"none"!==g},findChildWithLargestContent:function(g,a,b){var c=l.getAggregator().request("mobileApp").isMobileAppEnvironment(),d=this.hasBackgroundImage,e=function(a){for(var b=a;a.parentNode!==g&&"inline"!==A.getStyle(a.parentNode,
...
"hidden"===A.getStyle(m,"visibility"))){var r=x=void 0;m=m.childNodes;for(x=0;x<m.length;x++)1===m[x].nodeType&&(r=!0);x=!r}m=!x}var t;try{var r=x=void 0,B=!1,L=h&&"IFRAME"===h.nodeName&&h.contentDocument;h&&h.parentElement&&"teads-player"===h.parentElement.classList.item(0)&&L&&(r=(x=L.body)&&1>x.childElementCount)&&(B=!0);t=B}catch(E){t=!1}l>s&&m&&!t&&(k=h,s=l)}k&&(k.hasValidSizeForMobileApp=1<s);return k}(function(b){var c,d,e,k,g=[],s=a||"iframe img a object embed div".split(" ");c=0;for(d=s.length;c<
d;c++){e=s[c].toLowerCase();var f=b.getElementsByTagName&&b.getElementsByTagName(e);if(f&&f.length)for(e=0,k=f.length;e<k;e++)g.push(f[e])}return g}(g));s&&(k=f.isFunction(b)?s:e(s),k.hasValidSizeForMobileApp=s.hasValidSizeForMobileApp);return k},screenSize:function(){if(t.isDomless())return{width:0,height:0};var g={width:-1,height:-1};try{f.isDef(w.screen)&&(g={width:w.screen.width,height:w.screen.height})}catch(a){}return g},calcMonDims:function(){var g=f(u.screenSize()).mixin({scrX:0,scrY:0});
f.isDef(screen.availLeft)&&(g={scrX:w.screen.availLeft,scrY:w.screen.availTop,width:w.screen.availWidth,height:w.screen.availHeight});return g},getOurIFrameInTop:function(){for(var g,a=r.getTop(),b=r.getWindow();b!=a;)g=b,b=g.parent;return g},getOurNodeInTop:function(){var g;t.friendly&&(g=t.embedded?(g=u.getOurIFrameInTop())&&g.frameElement:m.contextNode);return g},getAncestorNodes:function(g){var a=[],b=g.ownerDocument&&g.ownerDocument.documentElement;if(b)for(;g.parentNode!==b;)a.push(g),g=g.parentNode;
...
b){if(f.isDef(m[b]))return 1}).length===a.length},getEnabledScriptUrl:function(a){var c=b("use"+a);a=m.sp_cdnScripts&&m.sp_cdnScripts[a];return c&&a},output:function(){return f(e()).toParams()}}},Bb=function(){return{calcInitialViewState:function(a,b){var c;c={IN_VIEW:65,OUT_OF_VIEW:25,PARTIAL_VIEW:30};var d={IN_VIEW:75,OUT_OF_VIEW:25,PARTIAL_VIEW:50},e=h.NA;c=b?c:d;f.isDef(a)&&a!==h.NA&&-1<a&&(e=a>=c.IN_VIEW?h.IN_VIEW:a<=c.OUT_OF_VIEW?h.OUT_OF_VIEW:a>=c.PARTIAL_VIEW?h.PARTIAL_VIEW_PLUS:h.PARTIAL_VIEW_MINUS);
return e},calcPercentInView:function(a,b,c,d){var e=0,k=a;a.hasValidDims()&&!a.isHidden()&&(f([b,c,d]).each(function(a,b){if(b.hasValidDims()){var c=k.getRounded(),d=b.getRounded(),e=Math.max(c.scrX,d.scrX),f=Math.max(c.scrY,d.scrY),h=Math.min(c.scrX+c.width,d.scrX+d.width),c=Math.min(c.scrY+c.height,d.scrY+d.height),h=h-e,c=c-f;k=F({scrX:e,scrY:f,width:0<h?h:0,height:0<c?c:0})}}),e=r.round(k.area()/a.area()*100));return e}}},pb=function(){var a,b=!1,c;a=function(a){var b=[];b.push(a.slice(0,8));
b.push(a.slice(8,12));b.push(a.slice(12,16));b.push(a.slice(16,20));b.push(a.slice(20));return b.join("-")}(function(){var a="";try{for(var b,c=w.Uint32Array&&w.crypto&&w.crypto.getRandomValues;32>a.length;)c?(b=new Uint32Array(1),w.crypto.getRandomValues(b),a+=b[0].toString(16)):a+=(16*r.random()|0).toString(16);a=a.slice(0,32)}catch(d){l.getAggregator().trigger("error",h.ERROR_CODES.UID_GENERATION)}return a}());var d=function(){return m.anId};return{getAsid:function(){return m.asid},getAnId:d,getCacheBustId:function(){var a=
new Date,b=Date.parse("Jan 1 "+a.getFullYear()),a=a.getTime()-b;return f.toBase(a,62)},getFwId:function(){return d()||m.advEntityId+"-"+m.pubEntityId},impressionIsIdentifiable:function(a){a&&(b=!0);return b},unq:a,getAvidIds:function(){return c},setAvidAdSessionContext:function(a){c=a}}},ib=function(a,b){return{init:function(c){a.jsonp(c,function(a){b.send(h.DT_CODES.THIRD_PARTY,void 0,!1,!0,{field:"tpiLookup",value:a})},!1,"callback")}}},oc=function(a,b,c,d,e){return{getTime:function(){return 1E3*
...
{output:"q"},"cmr",{type:h.DT_CODES.CUSTOM}),l.getAggregator().trigger("sendDt",h.DT_CODES.CUSTOM,q),b.rtsCallbacks&&f.isFunction(b.rtsCallbacks[h.RTS_KEY_FOR_VQ])&&b.rtsCallbacks[h.RTS_KEY_FOR_VQ]())})};return{init:function(){d();l.getAggregator().on("videoQuartileEvent",function(a){d();e(a)})}}},na=function(){var a=function(a,b){-1!==a.indexOf(b+"&")&&(b+="&");return a.replace(b,"")},b=function(a,b,c){var f=a.indexOf("?");b=b+"="+c;if(-1===f)return a+"?"+b;f++;return a.slice(0,f)+b+"&"+a.slice(f)},
c=function(){var a=m.asid;return"__IntegralAS_"+(a&&a.replace(/\-/g,"")||"")+"_"+r.round(1E4*Math.random())};return{wrap:function(d,e,k,f){var n=c(),p,q,h;f=f||"ias_callback";d=""+d;RegExp(f).test(d)&&(p=RegExp("("+f+"=)(.[^&]*)").exec(d)[0],q=p.split("=")[1],h=P.stringToFn(q),d=a(d,p));w[n]=function(a){e(a);k&&h&&h(a);w[n]=void 0};return d=b(d,f,n)},wrapToGlobal:function(a){var b=c();w[b]=function(c){a(c);w[b]=void 0};return b}}},Jb=function(a,b,c){var d=function(a,b){var c=a,d;b&&(d=","+f(b).stringify(function(a,
...
b?(b=r.getWindow(),b=t.friendly&&b.top.document&&(f.isFunction(b.top.document.hasFocus)||f(b.top.document.hasFocus).isObj())&&!b.top.document.hasFocus()||(f.isDef(a.prop)?r.getDoc()[a.prop]:null)):b=f.isDef(a.prop)?r.getDoc()[a.prop]:null;return b},s=function(){var b=r.getWindow(),c=function(){e.run(k())};A.addEvent(b,"focus",c,!0);A.addEvent(b,"blur",c,!0);a.event&&A.addEvent(r.getDoc(),a.event,c,!0)};a=function(){var a="hidden",c="visibilitychange",d=r.getDoc();f.isUndef(d.hidden)?f(["moz","ms",
"webkit"]).each(function(e,k){var s=k+"Hidden";f.isDef(d[s])&&(a=s,c=k+c,b=!0)}):b=!0;return b?{prop:a,event:c}:{}}();return{isHidden:k,onHiddenChange:function(a){e.push(a);c||(c=!0,s())},supportsVisAPI:function(){return b}}},pc=function(){return{isHidden:function(){return!1},onHiddenChange:function(a){},supportsVisAPI:function(){return!0}}},yb=function(){return{createInstance:function(a,b){return t.isDomless()?new rc:new sc(a,b)}}},sc=function(a,b){var c,d=function(a){for(var b in a)if(a.hasOwnProperty(b)){var c=
...
getCurrentEvent:function(){return k}}},P={hashCode:function(a){var b=0,c,d,e;if(0===a.length)return b;c=0;for(e=a.length;c<e;c++)d=a.charCodeAt(c),b=(b<<5)-b+d,b|=0;return b},rot:function(a){return a.replace(/[a-zA-Z]/g,function(a){return String.fromCharCode(("Z">=a?90:122)>=(a=a.charCodeAt(0)+13)?a:a-26)})},stringToFn:function(a){var b,c=w,d=a.split(".");for(a=0;a<d.length;a++)if(b=c,c=c[d[a]],f.isUndef(c)||a===d.length-1&&!f.isFunction(c))return!1;return function(){c.apply(b,arguments)}},stringToProp:function(a){var b=
r.getWindow(),c=a.split(".");for(a=0;a<c.length&&(b=b[c[a]],!f.isUndef(b));a++);return b},contains:function(a,b){return f.isStr(a)?-1!==a.indexOf(b):!1},trim:function(a){return f.isFunction(a.trim)?a.trim():a.replace(" ","")}},tc=function(){var a=function(){var a=function(a){return a&&a.width&&30<a.width&&a.height&&30<a.height},b=function(b){b=u.getDimensionFromAttributes(b);return a(b)};return{hasValidDimensions:function(c){var d;(d=b(c))||(c=u.getDimensionFromStyle(c),d=a(c));return d},hasValidDimentionAttributes:b}}(),
...
function(){var a=r.getWindow().document,b=a.body?Math.round(u.getNodeArea(a.body)):null;!l.getAggregator().request("mobileApp").isMobileAppEnvironment()&&b&&Fa(a,"bs2",10,b)},{tier:h.TIERS.VIEWABILITY,applies:function(a,b,c){b=!a.bootstrapOn("app")&&!c.isDomless();return a.on("bbs")&&c.embedded&&b}});var tb=function(){return{createInstance:function(a){return t.isDomless()?new wc:new xc(a)}}},xc=function(a){var b,c,d,e=new ya,k=new ga,s=new yc(e),n=new zc,p=new Ac,q=new Bc(e,a),h=function(){f.isUndef(d)&&
...
q()},isStarted:function(){return k},getAdNodeDimensions:function(){var a;c&&(a=F({scrX:void 0,scrY:void 0,width:c.width,height:c.height}));return a},isReady:function(){return d!==h.NA}}},va=function(){var a=!1;(function(){A.whenReady(function(){l.getAggregator().trigger("startViewabilityLoop");a=!0})})();return{loopStarted:function(){return a}}};l("loopDelay",[],va,{applies:function(a,b,c){return a.bootstrapOn("allowViewability")},tier:h.TIERS.VIEWABILITY});var Ic=function(){return{start:function(a){l.getAggregator().on("measurable",
...
h.DT_CODES.VIDEO_EVENTS)}catch(E){__IntegralASDiagnosticCall("omidvideo",E,w.bootstrapper)}};return{start:function(){l.getAggregator().on("impressionsent",q);l.getAggregator().provide({omidVideoEventsString:p});a.addEventListener("video",z);n.init()},addVideoPlaybackEventListener:function(a){b.on("videoPlaybackEvent",a)}}},Ha=function(a,b){var c=!1,d=function(a){var d=a.percentageInView;c=!0;a.viewState=50<=d?h.IN_VIEW:h.OUT_OF_VIEW;a.outOfViewReason=50<=d?"":h.OUT_OF_VIEW_REASONS.GEOM;b.trigger("measurementChanged",
...
c){var d=l.getAggregator().request("mobileApp");return{create:function(){var e=[],e=e.concat(a.getOmidMeasurementStrategies()),e=e.concat(a.getAvidMeasurementStrategies()),e=e.concat(a.getMraidMeasurementStrategies());(e=(new ja(e)).resolve())||l.getAggregator().trigger("addOutputItem",{output:"0"},"oam",{type:"impression"});var f=new Vc(e),s=new Ia(b,c,t,d);return b.on("mobSafIO")||e||!s.accepts()?new Uc(e,f,d.isMobileAppEnvironment()):new Wc(t.isVideo(),new H)}}},sb=function(a){var b=l.getAggregator().request("mobileApp");
return{getOmidMeasurementStrategies:function(){var a=l.getAggregator().request("omidVerificationClient"),b=new da(a),e=new Ca,f=[];if(b.accepts()&&!e.accepts()){var s=new ea,n=new Xc,e=new Yc(a,new H),s=[{environment:s,measurementStrategy:new Zc(a,new H)},{environment:n,measurementStrategy:new Ja(new ka,r.getWindow(),new H)}],s=(s=(new ja(s)).resolve())?s.measurementStrategy:{},p=new Ka(new La(new V),new V,n.accepts()),n=new Pc(a,b,m.mode),q=new Ma(e,s,new H,p),b=new Qc(a,b,m.mode),a=new Na(e,s,new Tc(a,
new H),new H,p);f.push({environment:n,measurementStrategy:q});f.push({environment:b,measurementStrategy:a})}return f},getAvidMeasurementStrategies:function(){var b=l.getAggregator().request("avidJsClient"),d=new Nc(b),e=[];if(d.accepts()){var f=new Mc(b,d,m.mode),s=new Oc(b,d,m.mode),n;n=new Rc(b,new H);if(d.supportsAdContainerGeometry()){var p=new $c,q=new ad,h=new Ja(new ka,r.getWindow(),new H),C=new bd(b,new H),p=(p=(new ja([{environment:p,measurementStrategy:C},{environment:q,measurementStrategy:h}])).resolve())?
p.measurementStrategy:{},q=new Ka(new La(new V),new V,q.accepts()),h=new cd(b,new H),b=new Ma(h,p,new H,q);n=new Na(h,p,n,new H,q)}else q=new Sc(b,new H),b=new Ha(q,new H),n=new Oa(q,n,new H);e.push({environment:f,measurementStrategy:b});e.push({environment:s,measurementStrategy:n});a.setAvidAdSessionContext(d.getAvidAdSessionContext())}return e},getMraidMeasurementStrategies:function(){var a=[],d=b.isSafeToInjectMraid(),d=new dd(r.getWindow(),d,b.isMobileAppEnvironment());if(d.accepts()){var e=l.getAggregator().request("context"),
e=new ed(r.getWindow(),e),f=new fd(r.getWindow(),new H);e.accepts()?(d=new gd(r.getWindow(),new H),d=new Oa(f,d,new H),d={environment:e,measurementStrategy:d}):(e=new Ha(f,new H),d={environment:d,measurementStrategy:e});a.push(d)}return a}}},ja=function(a){return{resolve:function(){var b=f(a).findFirst(function(a,b){return b.environment.accepts()});if(f.isDef(b))return b}}},Vc=function(a){var b=!1,c,d={winDimensions:F({scrX:0,scrY:0,width:0,height:0}),adDimensions:F({scrX:0,scrY:0,width:0,height:0}),
containerDimensions:F({scrX:0,scrY:0,width:0,height:0}),method:h.NA,viewState:h.NA,percentInView:h.PIV_NA,reason:"",obstructed:h.NA,isHidden:h.NA,tabHidden:h.NA,posViewState:h.NA,adCompCount:1},e=function(a){return a?new F({scrX:a.x,scrY:a.y,width:a.width,height:a.height}):F({scrX:0,scrY:0,width:0,height:0})},k=function(a){c={winDimensions:e(a.windowDimensions),adDimensions:e(a.adDimensions),containerDimensions:e(a.containerDimensions),method:a.detectionMethod||h.NA,viewState:a.viewState||h.NA,percentInView:f.isDef(a.percentageInView)?
...
c)},addAdContainerGeometryMeasurementChangedListener:function(a){b.on(h.CONTAINER_GEOMETRY_MEASUREMENT_CHANGED,a)},translateAvidOutOfViewReasons:d}},Ka=function(a,b,c){function d(a,b,c){c=n(b,c);a=k(a,b,c);return a.width*a.height}var e=function(a,b){var c=Math.max(a.x,b.x),d=Math.max(a.y,b.y),e=Math.min(a.x+a.width,b.x+b.width),f=Math.min(a.y+a.height,b.y+b.height),e=e-c,f=f-d;return{x:c,y:d,width:0<e?e:0,height:0<f?f:0}},k=function(a,b,c){a=e(b,a);return e(c,{x:0,y:0,width:a.width,height:a.height})},
s=function(a,b){return{x:a.x+b.x,y:a.y+b.y,width:b.width,height:b.height}},n=function(a,b){return{x:b.x-a.x,y:b.y-a.y,width:b.width,height:b.height}};return{calculateGeometricMeasurement:function(e,q){if(f.isDef(e)&&f.isDef(q)){var z=e.viewport,l=e.computedAdContainer,m=l.obstructions,t=m&&0<m.length,u=e.originalAdContainer,x=q.adGeometry,D=q.adFound,Q=e.detectionMethod,B=0,z={x:0,y:0,width:z.width,height:z.height},L=s(u,x),E=e.outOfViewReason,w=0,J=0,A=t||!1,w=1>=x.width*x.height;c&&w&&(D=!1,E=E||
"",D||-1!==E.indexOf(h.OUT_OF_VIEW_REASONS.GEOM)||(E=h.OUT_OF_VIEW_REASONS.GEOM+(""!==E?"."+E:"")));if(D&&0<e.percentageInView){w=d(z,l,L);t?(B=n(l,L),B=k(z,l,B),B=s(l,B),B=a.calculateObstructedArea(B,m)):B=0;J=B;B=Math.round((w-J)/(L.width*L.height)*100);t&&0===J&&(A=!1);for(var x=(new F(L)).getRoundedGeometry(),D=A,y,t=0,J=b.getConfig(x).numberOfSlices,O=r.floor(x.height/J)||1,m=[],w=D?a.getObstructionStatusBySlice(J):[],W,t=0;t<J;t++)y=x.y+O*t,t==J-1&&(O=x.y+x.height-y),y={x:x.x,y:y,width:x.width,
height:O},W=d(z,l,y),y=1==W/(y.width*y.height),m.push(y);if(D)for(l=r.min(w.length,J),t=0;t<l;t++)m[t]=m[t]&&!w[t];l=m}else l=b.getConfig(x).defaultSliceArray;return{windowDimensions:z,containerDimensions:u,adDimensions:L,percentageInView:B,viewState:50<=B?h.IN_VIEW:h.OUT_OF_VIEW,outOfViewReason:50<=B?"":E||h.OUT_OF_VIEW_REASONS.GEOM,detectionMethod:Q,isObstructed:A,sliceStatus:l}}}}},$c=function(){return{accepts:function(){return t.isAvidNative()}}},bd=function(a,b){var c=function(a){var c=a.eventData.originalAdContainer;
a=!!c;c=(new F({x:0,y:0,width:a?c.width:0,height:a?c.height:0})).getRoundedGeometry();b.trigger("avidNativeGeometryChanged",{adGeometry:c,adFound:a})};return{start:function(){a.addEventListener("viewability",c)},addAdGeometryMeasurementChangedListener:function(a){b.on("avidNativeGeometryChanged",a)}}},ad=function(){return{accepts:function(){return t.isAvid()&&!t.isAvidNative()}}},Ma=function(a,b,c,d){var e,k,s,n=function(){if(f.isDef(e)&&f.isDef(k)){var a=d.calculateGeometricMeasurement(e,k);s=a.isMeasurable=
...
a.addAdContainerGeometryMeasurementChangedListener(t);a.start();b.addAdGeometryMeasurementChangedListener(u);b.start();c.addVideoPlaybackEventListener(x);c.start()},getStrategyName:function(){return h.MEASUREMENT_STRATEGY.VIDEO},addMeasurementChangedListener:function(a){d.on("videoGeometryMeasurementChanged",a)},isMeasurable:function(){return r}}},Ja=function(a,b,c){var d,e=function(){var b=a.find(),e,n,p=!1;f.isDef(b)?(n=!0,e=b.getBoundingClientRect(),e={x:e.left,y:e.top,width:e.width,height:e.height},
...
a=f.isDef(a)?f.isFunction(a.getTimeInViewForRts)&&a.getTimeInViewForRts():h.RTS_KEY_FOR_VQ,e[a]=m.rts[n])})();return{timeInViewThresholds:c,qivThreshold:d,type:h.DT_CODES.CUSTOM,rts:e,isInView:q,isInViewIgnoringRender:function(a){return q(a,!0)},metricId:n,minUnit:a.minunit?1E3*a.minunit:1E3,thresholdType:a.thresholdType,shouldIncludeSound:p,sendOtherwiseInViewSignal:!0}},db=function(a,b,c){var d=b.isVideo()?"video":"display",e=b.isMobileApp()?"app":"web",k=b.isDeviceTypeGroupMobile()?"mobile":"desktop",
h=f(a.customViewability).isArray()&&0<a.customViewability.length,n=c.on("customMetric"),p=c.on("groupmCM"),q=function(a,b){var c,h,n,q,s;c=f(b.mediaTypes).contains(d);h=f(b.distributionChannels).contains(e);n=f.isDef(b.deviceGroups)?f(b.deviceGroups).contains(k):!0;q=P.contains(b.id,"fiv");s=P.contains(b.id,"groupmCM");q=!q;s&&(q=p);return q&&c&&h&&n};return{resolve:function(){var b=[],c;n&&h&&(c=f(a.customViewability).filter(q),f(c).each(function(a,c){b.push(c)}));return b}}},R=function(a){var b=
...
Q,"")},cleanup:function(){u.removeAttributeOf(J,Q)},isNode:function(a){return b===a},isHidden:W,isObstructed:function(){return!1},getDims:ba,getPercentInView:H,getLocationState:O,getOnPageViewability:function(){return W()?h.OUT_OF_VIEW:O()},getDetectionMethod:function(){return c},getContainerDims:function(){return D.allowsOptimization?s:F(d)},refresh:function(){K=G=v=C=n=s=void 0;if(k){var a,c;if(!t.isDomless()&&(c=b.parentNode)){for(;b!==w&&c&&c!==N&&!a;)a=c===d,c=c.parentNode;a||(d=b.parentNode)}}},
getAdNode:function(){return b},getSliceStatus:function(){var a;q&&q.isReadyToMeasure()?a=q.getSliceStatus():t.friendly&&z&&f.isDef(G)&&(a=z.getSliceStatus(G,v,C,K));return a}}},ud=function(a,b){var c=[],d,e=f([]),k=b.on("rvCombo"),s=function(){return c[0]&&c[0].getDetectionMethod()===h.DETECTION_METHODS.AD_PLACEHOLDER},n=function(k,n,p,q){var m=s()||0===c.length;k=td(a,k,n,p,b,q);s()&&(q=c.shift(),e=f(c),q.cleanup(),d=void 0);c.push(k);e=f(c);m&&k.mark();m&&n!==h.DETECTION_METHODS.AD_PLACEHOLDER&&
...
q={};try{var m,C,v,G,w,x,D=r.getMaxNumber(),A=r.getMaxNumber();t.friendly?(m=s(),v=m.left,G=m.top,D=m.width,A=m.height,C=u.browserWindowPosition(),w=C.scrX+v,x=C.scrY+G):e.on("rattie")&&k.browserIs(h.BROWSERS.IE)?(d=d||l.getAggregator().request("ieXDomainViewability"),c=d.determineFramePosition(),w=c.scrX,x=c.scrY):f.isDef(a.mozInnerScreenX)&&(w=r.round(a.mozInnerScreenX),x=r.round(a.mozInnerScreenY));var q={scrX:w,scrY:x,iFrameClippingWidth:D,iFrameClippingHeight:A},B,L,E=b||u.getIeDimObj(a);b=E;
f.isDef(a.innerWidth)?(B=a.innerWidth,L=a.innerHeight):E&&f.isDef(E.clientWidth)?(B=E.clientWidth,L=E.clientHeight,0===B&&0<E.offsetWidth&&(B=E.offsetWidth),0===L&&0<E.offsetHeight&&(L=E.offsetHeight)):a.frameElement&&f.isDef(a.frameElement.clientWidth)&&(B=a.frameElement.clientWidth,L=a.frameElement.clientHeight);n=B;q.height=L;q.width=n}catch(y){l.getAggregator().trigger("error",h.ERROR_CODES.GET_AD_DIMENSIONS)}return q};return{calcDims:function(){return new F(n())},getClippedDims:function(){var a=
n();return new F({scrX:a.scrX,scrY:a.scrY,width:a.iFrameClippingWidth,height:a.iFrameClippingHeight})}}},Eb=function(){return{createInstance:function(a,b,c){return t.isDomless()?new Ld:new Md(a,b,c)}}},Md=function(a,b,c){var d,e=m&&m.contextNode&&m.contextNode.parentNode?m.contextNode.parentNode:null,k=ud(b,c),l=function(){var a,b,e;d=d||Dd(t,c);a=d.find();!a&&d.usePlaceholder?n():a&&(a=f(a).isArray()?a:[a],b=d.getAdContainer(),e=d.allowForAdContainerChange,f(a).each(function(a,c){k.addAdComponent(c,
...
b){e()?c.push({type:a,functionToExecute:b}):d.avid.addEventListener(a,b)},getHtmlVideoAvidAdSessionListener:function(){if(e())throw"`HtmlVideoAvidAdSessionListener` is not available while in stub mode.";return d.avid.getHtmlVideoAvidAdSessionListener()}}},mb=function(a){var b=new Nd,c=new Od;(function(){var d="";try{if(a.bootstrapOn("mobOrTab")||t.isDomless())d=b.detect(),b.hasDetectedMobileApp()&&(c.detect(),l.getAggregator().trigger("addOutputItem",{output:"1"},"mapp",{type:"impression"}),l.getAggregator().trigger("addOutputItem",
{output:d},"drul",{type:"impression"}))}catch(e){l.getAggregator().trigger("error",h.ERROR_CODES.MOBILE_APP)}})();return{isMobileAppEnvironment:function(){return b.hasDetectedMobileApp()},isSafeToInjectMraid:function(){return c.isSafeToInjectMraid()}}},Pd={url:{STRINGIFIED_METHOD:"u",detect:function(a){if(t.isDomless())return!1;var b=r.getWindow().location.href,c=[b];try{c.push(top.location.href)}catch(d){}try{c.push(parent.location.href)}catch(e){}if(t.embedded){try{c.push(parent.document.referrer)}catch(k){}try{c.push(N.referrer)}catch(h){}}try{"jsi"!==
...
Nd=function(){var a,b=function(){return void 0!==a&&""!==a},c=function(a,b){var c,f=Pa().process(b.detectionRules);f&&(c=f+"_"+b.STRINGIFIED_APPDET);return c};return{detect:function(){m.hasOwnProperty("serverSideAppDetection")&&0!==m.serverSideAppDetection.length?a="s_serv":(a=f(Qd).map(c),a=0<a.length?a[0]:"");return a},hasDetectedMobileApp:b,setMobileAppDetectionRuleToSdk:function(){b()||(a="s_sdks");return a}}},Od=function(){var a=[],b=[],c=function(b,c){var f,h=Pa().process(c.detectionRules);
...
if(w=!s&&q){var m;q=e.getPercentInView();var B=x(),O=1===b.tabHidden;u=r.now()-z;m=0<z?900>u:!0;z=r.now();0===b.adDimensions.area()&&(q=0);m||(q=0);var A=q;p.push({tm:t.getTagTime(),piv:A});3<p.length&&p.shift();0===q&&0<B&&(m&&(m=p.length-1,A=!0,2<=p.length&&-1<m&&(A=0===p[m].piv&&0===p[m-1].piv),m=!A),m&&(q=B));a?(f.isUndef(n)&&(n=l.getAggregator().request("video")),n.setVideoSpecificScreenEventFields(b),q=b.isVideoPlayingInFullscreen?!0:!O&&50<=q&&b.isVideoPlaying):q=!O&&50<=q;b.viewState=q?h.IN_VIEW:
h.OUT_OF_VIEW;b.percentInView=x();B=[];O=f(b.reason);m=h.OUT_OF_VIEW_REASONS;q||B.push(m.GEOM);O.contains(m.HIDDEN)&&B.push(m.HIDDEN);O.contains(m.OBSTRUCTION)&&B.push(m.OBSTRUCTION);b.reason=B;b.sliceStatus=e.getSliceStatus();v||(v=!0,r.execAtEndOfThread(D))}else b.viewState=h.NA,b.percentInView=-1;return b},start:function(){l.getAggregator().on("endAdSession",B);c&&r.setTimeout(L,2E3)},getStrategyName:function(){return"mobileWebXdomainSafari"},isMeasurable:function(){return w},isImmediate:function(){return!0},
...
0===d:c;b&&c&&a.addState({isFullyInView:function(){return!1}})},e=function(){a&&a.hasAlwaysBeen(!0)&&l.getAggregator().trigger("sendDt",h.DT_CODES.QUARTILE_FULLY_INVIEW)},k=function(){b=!0;d()},m=function(a){a=(new Qa).getVolumeFromContext(a);d(a)};return{isApplicable:function(a){return a.usesGroupMCustomMetric()},start:function(c){l.getAggregator().on({adVideoStart:k,adImpression:k,volumeChanged:m,adVideoMidpoint:e});a=c.createViewabilityTracker("mpt",function(a){var c=l.getAggregator().request("isFullyInViewProvider");
return!b||c&&c.isFullyInView(a)})}}},Zd=function(){var a={AdPaused:"pauseAd",AdVolumeChange:"volumeChanged",AdPlaying:"resumeAd"};return{translate:function(b){var c=b.charAt(0).toLowerCase()+b.slice(1);b in a&&(c=a[b]);return c}}},Qa=function(){return{getVolumeFromContext:function(a){var b,c=-1;f.isDef(a)&&(f.isDef(a.volume)?c=a.volume:f.isDef(a.adVolume)&&(c=a.adVolume));-1!==c&&(b=c);return b}}},hb=function(a,b,c){var d="IASid"+a,e="getIasVidBridgeVersion"+a,k,s,n,p=[],q=h.OUT_OF_VIEW,u=!1,w=!1,
v=!1,y=!0,K=new Xd,x=Yd(),D=new Vd,F=new Qa,B=new Ea,H=function(b){var d;u=!0;var e={};try{e=JSON.parse(unescape(b&&b.data?b.data:b))}catch(f){e={}}e.id==a&&(d=K.registerEvent(e,c.getCurrentLoc()),d.indicatesPlaying()?(w=!0,q=v?h.IN_VIEW:!1):d.indicatesNotPlaying()?(w=!1,q=h.OUT_OF_VIEW):d.indicatesFullscreen()?(v=!0,q=w?h.IN_VIEW:h.OUT_OF_VIEW):d.indicatesNormalSize()&&(v=!1,q=w?!1:h.OUT_OF_VIEW),b=parseFloat(d.getVolume(F)),0<b?y=!0:0===b&&(y=!1));p.push(d);n&&M();return d},E=function(b){var c,
k,h=na().wrapToGlobal(H),q=function(a){f.isStr(a)&&(l.getAggregator().provide("vc",function(){return a}),l.getAggregator().trigger("addOutputItem",{output:a},"vc",{type:"impression"}))};try{k=b[e]||b.getIasVidBridgeVersion,c=f.isFunction(k)&&"2"===k.call(b)?unescape(b[d].call(b,a,h)):unescape(b[d].call(b,a)),u=!0,q(c||"n")}catch(n){__IntegralASDiagnosticCall("handshakefailure",n,m)}},I=function(){var c=function(a){return f(f(a).toArray()).findFirst(function(a,b){return f.isFunction(b[d])})};k||(f(["*[data-integralas-vid-"+
a+"]",".integral-vid-"+a,"ias-ad","object","embed"]).findFirst(function(a,b){var d=r.getDoc().querySelectorAll(b);return k=c(d)}),!k&&b.on("novidnodeerr")&&__IntegralASDiagnosticCall("novidnode",{},m));return k},J=function(){var a=I();a&&!u&&E(a);return a},N=function(a){a=F.getVolumeFromContext(a);y=f.isDef(a)?0<a:!1},M=function(){B.init();f(p).each(function(a,b){b&&(f.isUndef(b.sl)&&b.updateScreenLoc(c.getCurrentLoc()),b.trigger(),b.indicatesCompletion()&&l.getAggregator().trigger("adSessionComplete"),
b.indicatesQuartile()&&("adVideoComplete"!==b.tp&&l.getAggregator().trigger("sendDt",h.DT_CODES.VIDEO_EVENTS),l.getAggregator().trigger("videoQuartileEvent",b)))});p=[];n=!0};(function(){A.addEvent(r.getWindow(),"message",function(a){H(a)});l.getAggregator().on({volumeChanged:N});l.getAggregator().provide({videoEventsString:K,videoVersion:function(){var a,b=J();try{a=b.getVersion()}catch(c){a=-1,l.getAggregator().trigger("error",h.ERROR_CODES.NO_VIDEO_AD_INTERFACE)}return a},videoTranslator:function(){return s=
s||new Zd},adNode:J});J();D.listenForResult();x.isApplicable(t)&&x.start(c)})();return{findAdNode:J,getViewStateOverride:function(){return q},isHandshakeComplete:function(){return u},triggerInitializationEvents:M,setVideoSpecificScreenEventFields:function(a){var b=a.viewState===h.NA;a.isVideoPlaying=!0;a.isSoundOn=y;a.isVideoPlayingInFullscreen=!1;if(q){if(q===h.OUT_OF_VIEW){var c=a.reason?a.reason.split("."):[];c[c.length]=h.OUT_OF_VIEW_REASONS.VIDEO;a.reason=c.join(".")}a.viewState=b?a.viewState:
q;a.isVideoPlaying=q===h.IN_VIEW}v&&w&&(a.percentInView=100,a.isVideoPlayingInFullscreen=!0)}}},$d=function(){return new ca(h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.AS.COUNT)},Sb=function(){var a,b,c={},d=0,e=function(c){if(c||a)d+=5,b.onTick(d,function(){a?e():l.getAggregator().trigger("sendDt",h.DT_CODES.PERFORMANCE)}),a=!1},k=function(){b=new Ba;d=0;e(!0);b.start()},m=function(d,e,h,l){d=c[d];l?(f.isDef(d[e])||(d[e]=[]),d[e].push(h)):d[e]=h;b&&b.isActive()||
...
b){c[b]={}})}}},Xb=function(){var a={},b=function(b){a[b]||(a[b]=new Aa(1,m.birthdate));return a[b]},c=function(a){b(a).start()},d=function(a){var c=b(a);c.stop();l.getAggregator().trigger("addThrottledProp","im",a,c.getTime())};return{start:function(){l.getAggregator().on({markTime:c,measureTime:d})},isApplicable:function(a){return a.on("pIntervals")}}},ae=function(){return new ca(h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.TYPE,h.PERF_TIMELINE_TRACKER_CONFIG.WRAPPERS.JS.COUNT)},Cb=function(a){var b=
...
h.ERROR_CODES.GDPR)}};return d},getCallId:function(){return"ias_"+m.asid},send:function(a,b){l.getAggregator().trigger("addThrottledProp",h.DT_SLOT.ENVIRONMENT,a,b)}};l("CCPAConsentDetector",[],function(){function a(a){a&&M.send(b,f(a).toION())}var b="ccd";(function(){var b=M.isFrameworkAvailable("__uspapi","__uspapiLocator");M.send("cca",!!b);if(b){var d,e;f.isFunction(b)?b("getUSPData",1,a):(d={__uspapiCall:{command:"getUSPData",version:1,callId:M.getCallId()}},e=M.getMessageHandler("__uspapiReturn",
...
2E3);u=v;if(t.integratedBlockingApplies(r)){v=r;var y=l.getAggregator().request("mobileApp"),x=y&&y.isMobileAppEnvironment&&y.isMobileAppEnvironment(),A=m.contextNode.getAttribute("data-ias-container"),F=m.contextNode.getAttribute("data-ias-callback"),y=v+"adContainerId="+A+"&cbFunctionName="+F,y=x?y.replace("monitoring","blocking"):y.replace("skeleton.js",m.integration+".js"),B=m.protocol+":"+m.staticServer+m.integration+"a.js",H=m.protocol+":"+m.staticServer+m.integration+".js",r=y+"&true_pb="+
encodeURIComponent(m.passback)+(x?"&redirectUrl="+encodeURIComponent(H):"")+(x?"&passback=":"&adsafe_pb=")+encodeURIComponent(B)+"&"}var x=r=r.replace(h.UNIQUE_ID_TOKEN,m.asid),E=r.length,I,J,M=n(m.sp_imp_jsInfo_minLength,0),B="";try{I=u-E-M,0<I&&(J=be(p,I,14,b.on("partialUrls")),B+=J.join("&"))}catch(N){a.add(h.ERROR_CODES.IMPRESSION_URLS)}r=x+B;p=r+="&"===r.slice(-1)?"":"&";var O,E="";try{O=u-r.length,E+=ce(O,"adsafe_jsinfo=",a,b,c,e,f,s)}catch(P){a.add(h.ERROR_CODES.JSINFO),E+="adsafe_jsinfo=e:"+
a.toString()}r=p+E;d.macroUrl&&(r+="&"===r.slice(-1)?"":"&",r+=d.macroUrl);q=r;d.sendImpression(q);m.impUrl=q;l.getAggregator().trigger("impressionsent")}catch(R){__IntegralASDiagnosticCall("impsend",R,m)}}}},ce=function(a,b,c,d,e,k,s,n){return function(c){var d=c.primary.join(","),h=b,k=0,l=function(a){if(a)return","+a};h.length+d.length+5<=a&&(h+=l(d),e.impressionIsIdentifiable(!0),f(c.secondary).each(function(b,c){h.length+c.length+5<=a?h+=l(c):k+=1}));return h+=",ov:"+k}(function(){var a,b;b=
...
(c||d)&&n.push(a+":"+b.output())});b.toString()&&n.push("e:"+b.toString());n.push(c.output());n.push("tt:"+m.mode);n.push("thd:"+f.stringifyTriState(p.supportsVisAPI()));n.push("et:"+(r.now()-m.birthdate));m.perf.mark("si");c.on("swapids")?n.push("oid:"+m.oid):n.push("uid:"+d.unq);n.push("v:19.8.86");n.push("sp:"+(m.isSplitMode?1:0));n.push("fwm:"+("true"===m.fwMonitoring?1:0));c.on("resolution")&&(n.push("wr:"+f(u.windowSize()).toArray().join(".")),n.push("sr:"+f(u.screenSize()).toArray().join(".")));
...
l.length+c;m=b-m;d&&m<f.length&&0<m&&(f=f.substr(0,m));if(f.length||""===e.val||""===e.type)f="adsafe_url="+f+"&adsafe_type="+l,l=h.join("&").length,f.length+l<=b&&h.push(f)}));return h},Nb=function(){return{isApplicable:function(a){a=r.getWindow();return!(!a.navigator||!a.navigator.plugins)},start:function(a){a=r.getWindow();a=ee(a.navigator.plugins);var b=a.hash(),c=b.join(".");l.getAggregator().trigger("addOutputItem",{output:c},"pl",{type:h.IMPRESSION_EVENT});b.length&&(a=a.decode(b),a=a.join("."),
...
{asid:m.asid,constant:h,features:b,context:t,dtBaseURL:m.dtBaseURL,spg:Sa};"function"===typeof c&&c(a,d)}},getMethodName:function(a){return"register_"+a}}},Vb=function(){return{start:function(a,b){f(a).each(function(a,d){b.getEnabledScriptUrl(d)&&he(d,b).start()})}}},ee=function(a){return{hash:function(){for(var b=0,c=a.length,d=[],e;b<c;b++)e=a[b].filename.replace(/\.plugin$/,""),e=P.hashCode(e),e=f.toBase(e,62).slice(-4),d.push(e);return d},decode:function(b){var c,d;c=r.floor(r.random()*b.length);
